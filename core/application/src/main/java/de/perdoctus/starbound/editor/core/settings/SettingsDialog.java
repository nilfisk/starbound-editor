package de.perdoctus.starbound.editor.core.settings;
...
public class SettingsDialog extends DefaultController<Settings> {
	...
	private SettingsDialog(final File settingsFile) {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("/de/perdoctus/starbound/editor/core/settings/Settings.fxml"), ResourceBundle.getBundle("de.perdoctus.starbound.editor.core.i18n"));
