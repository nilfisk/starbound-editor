package de.perdoctus.starbound.editor;

import de.perdoctus.starbound.editor.core.main.MainViewController;
...
public class StarboundEditor extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("/de/perdoctus/starbound/editor/core/MainView.fxml"), ResourceBundle.getBundle("de.perdoctus.starbound.editor.core.i18n"));
