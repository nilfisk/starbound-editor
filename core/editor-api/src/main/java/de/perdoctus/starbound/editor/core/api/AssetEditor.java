...
/**
 * A core implementation for Asset-Editors.
 *
...
public abstract class AssetEditor<T extends Asset> extends AnchorPane implements ChangeListener {
	...
	private Node createView(final AssetType assetType) throws IOException {
		final String editorFXMLLocation = assetType.getEditorFXML();
		final String editorResourceBundleLocation = assetType.getResourceBundle();
		final FXMLLoader loader = new FXMLLoader(getClass().getResource(editorFXMLLocation), ResourceBundle.getBundle(editorResourceBundleLocation));
